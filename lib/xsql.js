...
class Xsql {
  ...
  getColumnsForSelectStmtWithGrpBy(reqQueryParams, tableName, queryParamsObj) {
    ...
    if ('_aggFunc' in reqQueryParams && '_aggField' in reqQueryParams) {
      queryParamsObj.query += ',' + reqQueryParams._aggFunc + '(' + reqQueryParams._aggField + ') as _' + reqQueryParams._aggFunc + ' '
    } else {
